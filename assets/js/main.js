...
const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_g8llj1k','template_0mtdoug','#contact-form','x7zV4BJkLegdeVeDt')
    .then(() =>{
        // Show sent message
...
const scrollUp = () =>{
    ...
    // When the scroll is higher tahn 35o viewport height, add the show-scroll class to the a tag with the scrollup class
